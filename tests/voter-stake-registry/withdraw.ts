...
import { assertThrowsAnchorError, createRealm, createRegistrar, createVoter, defaultDepositConfig, defaultVotingConfig, fastup, lockupDayily, LockupTimeDuration, lockupTimeDurationSeconds, mintTokenToAccount, newSigner, newTokenAccount, VSR_PROGRAM } from "./helper";
...
//     const [incorrectRegistrar] = await createRegistrar(realm, authority, councilMint, defaultVotingConfig(), defaultDepositConfig(), authority);
...
//       .rpc();
//     // fastup 15 days
//     await fastup(registrar, authority, lockupTimeDurationSeconds(lockupDuration));
